            ...
            <Paper elevation={2} sx={{ p: { xs: 2, sm: 3 }, borderRadius: 3, textAlign: 'center', width: '100%', maxWidth: 600, mx: 'auto' }}>
                <Stack spacing={2}>
                    ...
                    <Box component="form" onSubmit={handleEmailSubmit} sx={{ display: 'flex', flexDirection: 'column', gap: 1.5 }}>
                        ...
                        <Button type="submit" variant="outlined" disabled={isSubmittingEmail} sx={{ textTransform: 'none' }} fullWidth startIcon={isSubmittingEmail ? <CircularProgress size={16} color="inherit" /> : 'Sign in with Email'} />
                        {/* <DemoLoginButton /> */}
